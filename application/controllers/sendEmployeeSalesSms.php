 ...
 // Check connection
  if (mysqli_connect_errno())
    ...
    while($row=$result->fetch_assoc()){
        ...
        SendAutometicAppointmentSms(8454801188,$row['expert'],date('d-m-Y',strtotime("-1 days")),$row['services'],$row['sales'],$row['business_outlet_sender_id'],$row['api_key']);
			}
    ...
    //
    function SendAutometicAppointmentSms($mobile,$name,$date,$services,$sale,$sender_id,$api_key){
		//API key & sender ID
