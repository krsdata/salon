<nav class="sidebar <?php if(isset($sidebar_collapsed)){ if($sidebar_collapsed){ echo 'sidebar-collapsed toggled'; }} ?>">
	<div class="sidebar-content">
		<a class="sidebar-brand" href="<?=base_url()?>index.php/SuperAdmin/Dashboard/">
			...
			<li class="sidebar-item">
		      ...
		      <i class="align-middle" data-feather="sliders" style="color:#0070c0;"></i> <span class="align-middle">Super Admin Panel</span>
				...
				<ul id="dashboards" class="sidebar-dropdown list-unstyled collapse show">
					<li class="sidebar-item"><a class="sidebar-link" href="<?=base_url()?>index.php/SuperAdmin/Dashboard/"><i data-feather="grid" style="color:#0070c0;"></i>Dashboard</a></li>
					<li class="sidebar-item">
						...
						<ul id="configurations" class="sidebar-dropdown list-unstyled collapse">
							<li class="sidebar-item"><a class="sidebar-link" href="<?=base_url()?>index.php/SuperAdmin/ResetAdminPassword/"><i data-feather="key" style="color:#eeb211;"></i>Reset Admin Password</a></li>
						</ul>
					</li>
					<li class="sidebar-item">
		      ...
		      <i class="align-middle" data-feather="users" style="color:#0070c0;"></i> <span class="align-middle">Customers</span>
				...
				<ul id="customers" class="sidebar-dropdown list-unstyled collapse">
					 <li class="sidebar-item"><a class="sidebar-link" href="<?=base_url()?>index.php/SuperAdmin/CustomerHistory"><i data-feather="clock" style="color:#0070c0;"></i>Transaction History</a></li> 
