                                            ...
                                            <div class="card" style="width: 18rem;;border:none">
                                                <div class="card-body">
                                                    ...
                                                    <div classs="row" style="text-align:center">
                                                        From&emsp;<input type="text" name="r1" value="<?=$timeline['res_arr']['r1']?>" style="width:4rem">&emsp;to&emsp;<input type="text" name="r2" value="<?=$timeline['res_arr']['r2']?>" style="width:4rem">
                                                    </div>
                                                </div>
                                            </div>
                                        <!-- </div> -->
                                        ...
                                        <!-- <div class="card-body"> -->
                                            <div class="card" style="width: 18rem;;border:none">
                                                <div class="card-body">
                                                    ...
                                                    <hr style="height:2px;border-width:0;color:gray;background-color:red">
                                                    <div classs="row" style="text-align:center">
                                                        Above&emsp;<input type="text" name="reg_cust" value="<?=$timeline['res_arr']['regular_cust']?>" style="width:4rem">
                                                    </div>
                                                </div>
                                            </div>
                                        <!-- </div> -->
                                        ...
                                        <!-- <div class="card-body"> -->
                                            <div class="card" style="width: 18rem;border:none">
                                                <div class="card-body">
                                                    ...
                                                    <hr style="height:2px;border-width:0;color:gray;background-color:red">
                                                    <div classs="row" style="text-align:center">
                                                        Last Visited <input type="text" name="risk_cust" value="<?=$timeline['res_arr']['at_risk_cust']?>" style="width:4rem"> days back
                                                    </div>
                                                </div>
                                            </div>
                                        <!-- </div> -->
                                        ...
                                        <!-- <div class="card-body"> -->
                                            <div class="card" style="width: 18rem;;border:none">
                                                <div class="card-body">
                                                    ...
                                                    <hr style="height:2px;border-width:0;color:gray;background-color:red">
                                                    <div classs="row" style="text-align:center">
                                                        Last Visited <input type="text" name="lost_cust" value="<?=$timeline['res_arr']['lost_customer']?>" style="width:4rem"> days back
                                                    </div>
                                                </div>
                                            </div>
                                        <!-- </div> -->
                                        ...
                                        <!-- <div class="card-body"> -->
                                            <div class="card" style="width: 18rem;;border:none">
                                                <div class="card-body">
                                                    ...
                                                    <!-- <h6 class="card-text" style="text-align:center">First Visit</h6> -->
                                                    <div classs="row" style="text-align:center">
                                                        From&emsp;<input type="text" name="r1" value="2" style="width:4rem">&emsp;to&emsp;<input type="text" value="5" name="r2" style="width:4rem">
                                                    </div>
                                                </div>
                                            </div>
                                        <!-- </div> -->
