							...
							<div class="tab-content">                           
									...
									<div class="accordion" id="accordionExample1">
													<div class="card">
														...
														<div id="collapseOneE" class="collapse show" aria-labelledby="headingOneE" data-parent="#accordionExample1">
															<div class="card-body" style="margin-right:10px;">
																<table class="table table-hover table-striped datatables-basic" id="TxnHistory" style="width:100%;">
																	<thead>
																		<tr>
																			<th>S.No</th>
																			<th>Outlet</th>
																			...
																			if(!empty($txnhistory)){	
																				...
																				?>
																					<tr>
																						...
																						<td><a class="EditViewCustomer" cust_id="<?=$txn['txn_customer_id']?>"><?=$txn['txn_customer_number']?></a></td>
													...
													<div class="card">
														<div class="card-header" id="headingTwoE">
															<div class="row">
																<div class="col-md-4">
																	<h5 class="card-title"><a href="#" data-toggle="collapse" data-target="#collapseTwoE" aria-expanded="true" aria-controls="collapseTwoE">
																	Package Transaction
										            			</a></h5>
																</div>
																<!-- <div class="col-md-5">
														...
														<div id="collapseTwoE" class="collapse" aria-labelledby="headingTwoE" data-parent="#accordionExample1">
															...
															<table class="table table-hover table-striped datatables-basic" id="PackageTxnHistory" style="width:100%;">
																	<thead>
																		<tr>
																			<th>S.No</th>
																			<th>Outlet</th>
																			...
																			if(!empty($txnhistorypackages)){
																				...
																				?>
																					<tr>
																						...
																						<td><a class="EditViewCustomer" cust_id="<?=$ptxn['package_txn_customer_id']?>"><?=$ptxn['customer_number']?></a></td>
								...
								<div class="tab-pane fade" id="tab-2" role="tabpanel">
                                	<div class="tab-pane fade show active" id="tab-2" role="tabpanel">
										...
										<table class="table table-hover table-striped datatables-basic" id="PrefferedService" style="width: 100%;">
											<thead>
												<tr>
													<th>S.No</th>
													<th>Outlet</th>
											...
											?>
												...
												<td><?=$ser['cust_name']?></td>
												<td><a class="EditViewCustomer" cust_id="<?=$ser['cust_id']?>"><?=$ser['cust_mobile']?></a></td>
										...
										<div class="card-header">
											...
											<table class="table table-hover table-striped datatables-basic" id="Products" style="width: 100%;">
												...
												<tr>
													...
													<td><a class="EditViewCustomer" cust_id="<?=$prod['cust_id']?>"><?=$prod['cust_mobile']?></a></td>
				...
				.done(function(data, textStatus, jqXHR) {
					...
					if(data.package.success == 'true'){
						...
						for(var i=0;i< data.package.res_arr.length;i++){
							...
							str_3 += "<td>" + parseInt(data.package.res_arr[i].package_txn_value+data.package.res_arr[i].discount) + "</td>";
