<nav class="sidebar <?php if(isset($sidebar_collapsed)){ if($sidebar_collapsed){ echo 'sidebar-collapsed toggled'; }} ?>">
	<div class="sidebar-content">
		<a class="sidebar-brand" href="<?=base_url()?>BusinessAdmin">
		...
		<ul class="sidebar-nav">
			...
			<li class="sidebar-item">
		      ...
		      <i class="align-middle" data-feather="sliders" style="color:#0070c0;"></i> <span class="align-middle">Business Panel</span>
				...
				<ul id="dashboards" class="sidebar-dropdown list-unstyled collapse show">
					<li class="sidebar-item"><a class="sidebar-link" href="<?=base_url()?>BusinessAdmin/Dashboard"><i data-feather="grid" style="color:#0070c0;"></i>Dashboard</a></li>
					<li class="sidebar-item">
		          ...
		          <span class="align-middle"><i data-feather="settings" style="color:#d50f25;"></i>Configurations</span>
			        ...
			        <li class="sidebar-item"><a class="sidebar-link" href="<?=base_url()?>BusinessAdmin/AddOutlet"><i data-feather="home" style="color:#eeb211;"></i>Outlets</a></li>
			    		...
			    		<li class="sidebar-item"><a class="sidebar-link" href="<?=base_url()?>BusinessAdmin/MenuManagement"><i data-feather="menu" style="color:#d50f25;"></i>Menu Management</a></li>
			...
			<li class="sidebar-item">
		      ...
		      <i class="align-middle" data-feather="users" style="color:#0070c0;"></i> <span class="align-middle">Loyalty</span>
				...
				<ul id="autoengage" class="sidebar-dropdown list-unstyled collapse">
					...
					<!--<li class="sidebar-item"><a class="sidebar-link" href="<?=base_url()?>BusinessAdmin/Loyalty"><i class="fa fa-rupee-sign" style="color:#009925;"></i>Loyalty Wallet</a></li>-->
					<li class="sidebar-item"><a class="sidebar-link" href="<?=base_url()?>BusinessAdmin/LoyaltyDashBoardIntegrated"><i class="fa fa-rupee-sign" style="color:#009925;"></i>Loyalty Management</a></li>
			...
			if(array_search('Deals&Discount', $business_admin_packages) !== false):
					...
					<li class="sidebar-item">
						...
						<ul id="deals" class="sidebar-dropdown list-unstyled collapse">
							 <li class="sidebar-item"><a class="sidebar-link" href="<?=base_url()?>BusinessAdmin/DealsDiscount"><i data-feather="clock" style="color:#0070c0;"></i>Deals & Discount</a></li>
							<!--<li class="sidebar-item"><a class="sidebar-link" href="<?=base_url()?>BusinessAdmin/Loyalty"><i class="fa fa-rupee-sign" style="color:#009925;"></i>Loyalty Wallet</a></li>-->
							<!-- <li class="sidebar-item"><a class="sidebar-link" href="<?=base_url()?>BusinessAdmin/LoyaltyDashBoardIntegrated"><i class="fa fa-rupee-sign" style="color:#009925;"></i>Loyalty Management</a></li> -->
			...
			<li class="sidebar-item">
		      ...
		      <i class="align-middle" data-feather="user" style="color:#0070c0;"></i> <span class="align-middle">People</span>
				...
				<ul id="EMSS" class="sidebar-dropdown list-unstyled collapse">
					...
					<li class="sidebar-item"><a class="sidebar-link" href="<?=base_url()?>BusinessAdmin/CheckEmployeeSalary"><i class="fa fa-rupee-sign" style="color:red;"></i>Salary</a></li>
					<li class="sidebar-item"><a class="sidebar-link" href="<?=base_url()?>BusinessAdmin/AdvancePayment"><i class="fa fa-rupee-sign" style="color:red;"></i>Advance Payment</a></li>
					<li class="sidebar-item"><a class="sidebar-link" href="<?=base_url()?>BusinessAdmin/Commission_opening"><i class="fa fa-rupee-sign" style="color:#009925;"></i>Commission</a></li>
			...
			<li class="sidebar-item">
				...
				<ul id="tryst" class="sidebar-dropdown list-unstyled collapse ">
					<!-- <li class="sidebar-item"><a class="sidebar-link" href="<?=base_url()?>BusinessAdmin/Appointment"><i data-feather="watch" style="color:orange"></i>View Appointment</a></li> -->
					<li class="sidebar-item"><a class="sidebar-link" href="<?=base_url()?>BusinessAdmin/IntegrateFacebook"><i data-feather="watch" style="color:orange"></i>Integrate Facebook Appointment</a></li>
