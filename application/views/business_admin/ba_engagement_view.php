					...
					<div class="col-md-12">
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="row">
                                    <div class="col-md-2" >
                                            <div class="card" style="width: 10rem;">
                                                <div class="card-body">
                                                    <h1 class="card-title" style="text-align:center;font-size:20px;font-weight:bolder"><?=$new?></h1>
                                    ...
                                    <div class="col-md-2">    
                                            ...
                                            <div class="card" style="width: 10rem">
                                                <div class="card-body">
                                                    <h1 class="card-title" style="text-align:center;font-size:20px;font-weight:bolder"><?=$repeat?></h1>
                                    ...
                                    <div class="col-md-2">    
                                            <div class="card" style="width: 10rem;">
                                                <div class="card-body">
													<h1 class="card-title" style="text-align:center;font-size:20px;font-weight:bolder"><?=$regular?></h1>
									...
									<div class="col-md-2">    
                                            <div class="card" style="width: 10rem;">
                                                <div class="card-body">
													<h1 class="card-title" style="text-align:center;font-size:20px;font-weight:bolder"><?=$custwithouttrans?></h1>
									...
									<div class="col-md-2">    
                                            <div class="card" style="width: 10rem;">
                                                <div class="card-body">
                                                    <h1 class="card-title" style="text-align:center;font-size:20px;font-weight:bolder"><?=$risk?></h1>
									...
									<div class="col-md-2">    
                                            <div class="card" style="width: 10rem;">
                                                <div class="card-body">
                                                    <h1 class="card-title" style="text-align:center;font-size:20px;font-weight:bolder"> <?=$lost?></h1>
								...
								<div class="row">
									<div class="col-lg-12" style="text-align:right;font-weight:bolder;font-size:large;margin-top:5mm"><label>All Customer : <?=$allcust?></label></div></div>
								<div class="row" style="margin-top:40px">
                                    ...
                                    <div class="col-md-3">
										<div class="form-group">
											<div class="input-group" style="width:300px;margin-top:25px">
												<input type="text" id="SearchCustomer" placeholder="Search Customer by name/contact no." class="form-control">
									...
									<div class="col-md-2">
                                        <label>&emsp;</label>
                                        <input style="float:right" type="submit" value="Download" id="download" name="download" class="form-control" style="width:100px">
                                    </div>
								</div>
	...
	$("#category").on('change', function(e) {
			...
			.done(function(data, textStatus, jqXHR) {
				if(category == 'All'){
					...
					var temp_str="<thead><th>S.No</th><th>Name</th><th>Number</th><th>Category</th><th>Total Spend</th><th>Last Visit Date</th></thead> ";
					for(var i = 0;i < data.result.length;i++){
						temp_str += "<tr>";
									temp_str += "<td>" + (i + 1) + "</td>";
									temp_str += "<td>" + data.result[i].Name + "</td>";
