			...
			<div class="container-fluid p-0">
				...
				<div class="row">
						...
						<div class="card">
							<div class="card-header" style="margin-left:10px;">
								<ul class="nav nav-pills card-header-pills pull-right" role="tablist" style="font-weight: bolder">
									...
									<!--<li class="nav-item">-->
									<!--	<a class="nav-link" data-toggle="tab" href="#tab-7">Recommendation</a>-->
									<!--</li>-->
								</ul>
							</div>
							<div class="card-body">
								<div class="tab-content">
									<div class="tab-pane show active" id="tab-1" role="tabpanel">
										...
										<?php if($permission['service_create']==1){?>
											<div class="row">
												...
												<div class="col-md-2">
													<button class="btn btn-primary download float-right mb-2" type="service" style="float: right" id="downloadotc"><i class="fa fa-file-export"></i>Download</button>
										...
										<table class="table table-striped datatables-basic" id="servicMenu" style="width: 100%;">
											...
											<tbody>
												...
												<tr>
												    ...
												    <td><?=number_format((($service['service_gst_percentage']*$service['service_price_inr'])/100),2)?></td>
													<td><?=number_format(($service['service_price_inr'] + (($service['service_gst_percentage']/100)*$service['service_price_inr'])),2)?></td>
									...
									<div class="tab-pane" id="tab-2" role="tabpanel">
										...
										<?php if($permission['product_create']==1){?>
											<div class="row">
												...
												<div class="col-md-2">
													<button class="btn btn-primary download float-right mb-2" type="otc" style="float: right" id="downloadotc"><i class="fa fa-file-export"></i>Download</button>
															<!-- <button class="btn btn-primary mb-2" onclick="exportTableToExcel('otcMenu','OTCMenu')"><i class="fa fa-file-export"></i>Product</button> -->
												</div>
											</div>
										<?php }?>
										...
										<table class="table table-striped datatables-basic" id="otcMenu" style="width: 100%;">
											...
											<tbody>
												...
												<tr>
													...
													<td><?=number_format(($otc['service_price_inr'] + (($otc['service_gst_percentage']/100)*$otc['service_price_inr'])),2)?></td>
									...
									<div class="tab-pane fade" id="tab-6" role="tabpanel">
											...
											<div class="row">
													<div class="col-md-12">
															<table class="table table-striped datatables-basic" id="servicMenu" style="width: 100%;text-align:center">
																			<thead>
																					<tr>
																							<th>Sno.</th>
																							<th>Category</th>
																			...
																			<tbody>
																					...
																					{   $i=0;
																							...
																							<tr>
																									...
																									<td><?=$recommend_service['Total Service']?></td>
																									<!-- <td class="table-action">
									...
									<div class="tab-pane fade" id="tab-7" role="tabpanel">
										...
										<div class="row">
											<div class="col-md-12">
												<form action="#" id="Recommendations">
													<div class="form-row">
														<div class="form-group col-md-6">
															<button class="btn btn-primary" data-toggle="modal" data-target="#ModalRecommendation"><i class="fas fa-fw fa-plus"></i> Add Recommendation</button>
														</div>
													</div>
													<div class="form-row">
														<div class="col-md-12">
															<table id="RecommService" class="table table-stripped datatables-basic">
																<tr>
																<thead>
																	<th>Sr.No</th>
																	<th>Base Service</th>
																...
																<?php $i=0; foreach($recommended_services as $rservice){ ?>
																<tr>
																	<td><?=$i=$i+1?></td>
																	<td><?=$rservice['service_name']?></td>
																	<td><?=$rservice['recommended_service']?></td>
																	<td>
																		<button type="button" class="btn r_services-edit-btn" rservice_id="<?=$rservice['id']?>">
																			<i class="align-middle" data-feather="edit-2"></i>
																		</button>
																		<button type="button" class="btn r_services-deactivate-btn" rservice_id="<?=$rservice['id']?>">
																			<i class="align-middle" data-feather="trash-2"></i>
																		</button>
																	</td>
																</tr>
					...
					<div class="col-md-12">
														...
														<tr>  
															<td>
																<div class="form-group">
																	...
																	<input type="number" class="form-control" id="q1" placeholder="Quantity Per Item" name="qty_per_item[]" min = "1">
																</div>
															</td>
															<td>		
																<div class="form-group">
						...
						<div class="modal" id="ModalRecommendation" tabindex="-1" role="dialog" aria-hidden="true">
							<div class="modal-dialog modal-dialog-centered modal-md" role="document">
								<div class="modal-content">
									<div class="modal-header">
										<h5 class="modal-title text-white">Recommendations</h5>
										<button type="button" class="close" data-dismiss="modal" aria-label="Close">
											<span aria-hidden="true">&times;</span>
										</button>
									</div>
									<div class="modal-body m-3">
										<div class="row">
											<div class="col-md-12">
												<form id="AddRecommendedServices" method="POST" action="#">
													<div class="row">
														<div class="col-md-6">
															<label>Select Base Service Product</label>
															<input type="text" id="searchserviceR" name="searchserviceR" class="form-control"> 
														</div>
														<div class="col-md-6">
															<label>Recommended Service Product</label>
															<input type="text" id="searchrecommended" name="searchrecommended" class="form-control"> 
														</div>
													</div>
													<div class="row" hidden>
														<div class="col-md-6">
															<label>Select Base Service Product</label>
															<input type="text" id="ServiceProductid" name="ServiceProductid" class="form-control"> 
														</div>
														<div class="col-md-6">
															<label>Recommended Service Product</label>
															<input type="text" id="RecommendedID" name="RecommendedID" class="form-control"> 
														</div>
													</div>
													<div class="row" >
						...
						<div class="modal" id="EditModalRecommendation" tabindex="-1" role="dialog" aria-hidden="true">
							<div class="modal-dialog modal-dialog-centered modal-md" role="document">
								<div class="modal-content">
									<div class="modal-header">
										<h5 class="modal-title text-white">Edit Recommendations</h5>
										<button type="button" class="close" data-dismiss="modal" aria-label="Close">
											<span aria-hidden="true">&times;</span>
										</button>
									</div>
									<div class="modal-body m-3">
										<div class="row">
											<div class="col-md-12">
												<form id="EditRecommendedServices" method="POST" action="#">
													<div class="row">
														<div class="col-md-6">
															<label>Select Base Service Product</label>
															<input type="text" id="editsearchserviceR" name="editsearchserviceR" class="form-control"> 
														</div>
														<div class="col-md-6">
															<label>Recommended Service Product</label>
															<input type="text" id="editsearchrecommended" name="editsearchrecommended" class="form-control"> 
														</div>
													</div>
													<div class="row" hidden>
														<div class="col-md-4">
															<label>Select Base Service Product</label>
															<input type="text" id="editServiceProductid" name="editServiceProductid" class="form-control"> 
														</div>
														<div class="col-md-4">
															<label>Recommended Service Product</label>
															<input type="text" id="editRecommendedID" name="editRecommendedID" class="form-control"> 
														</div>
														<div class="col-md-4">
...
<script type="text/javascript">
    ...
    $(document).on('click','.otc-edit-btn',function(event) {
      ...
      .done(function(data, textStatus, jqXHR) { 
        ...
        $("#EditOTCCategory select[name=otc_unit]").val(data.service_unit);
		...
		$("#EditOTCCategory select[name=otc_inventory_type]").val(data.inventory_type);//select
...
<script type="text/javascript">
function toTotal(no){
	var t2 = parseInt(document.getElementById("price"+no).value);
	var t1 = parseInt(document.getElementById("gst"+no).value);
	var t3 = t2+(t2 * (t1/100));
	//   alert(t2);
document.getElementById("total"+no).value = t3;
}
function toTotalstatic(){
	var t2 = parseInt(document.getElementById("price").value);
	var t1 = parseInt(document.getElementById("gst").value);
	var t3 = t2+(t2 * (t1/100));
	//   alert(t2);
...
<!-- download otc report  -->
<script type="text/javascript">
	$(document).on('click',"#downloadotc",function(event){
		event.preventDefault();
		this.blur();
			...
			$.getJSON("<?=base_url()?>index.php/BusinessAdmin/ServiceReportDownload/",parameters)	
			.done(function(data, textStatus, jqXHR) {
...
<!-- 02-05-2020 -->
<script>
	$("#searchserviceR").typeahead({
      autoselect: true,
      highlight: true,
      minLength: 1
     },
     {
      source: searchserviceR,
      templates: {
        empty: "No Services Found!",
        suggestion: _.template("<p class='searchserviceR'><%- service_name %>,<%- service_type %>,<%- qty_per_item %> </p>")
      }
    });
       
    var to_fill = "";

    $("#searchserviceR").on("typeahead:selected", function(eventObject, suggestion, name) {
      var loc = "#searchserviceR";
      to_fill = suggestion.service_name;
      setVals(loc,to_fill,suggestion);
    });

    $("#searchserviceR").blur(function(){
      $("#searchserviceR").val(to_fill);
      to_fill = "";
    });

    function searchserviceR(query, cb){
      ...
      $.ajax({
        url: "<?=base_url()?>index.php/BusinessAdmin/GetAllServices/",
        data: parameters,
        type: "GET",
        crossDomain: true,
				cache: false,
    ...
    function setVals(element,fill,suggestion){
      $(element).attr('value',fill);
      $(element).val(fill);
	  document.getElementById('ServiceProductid').value = suggestion.service_id;	
	}
</script>
<script>
	$("#searchrecommended").typeahead({
      autoselect: true,
      highlight: true,
      minLength: 1
     },
     {
      source: searchrecommended,
      templates: {
        empty: "No Services Found!",
        suggestion: _.template("<p class='searchrecommended'><%- service_name %>,<%- service_type %>,<%- qty_per_item %> </p>")
      }
    });
       
    var to_fill = "";

    $("#searchrecommended").on("typeahead:selected", function(eventObject, suggestion, name) {
      var loc = "#searchrecommended";
      to_fill = suggestion.service_name;
      setValsR(loc,to_fill,suggestion);
    });

    $("#searchrecommended").blur(function(){
      $("#searchrecommended").val(to_fill);
      to_fill = "";
    });

    function searchrecommended(query, cb){
    ...
    function setValsR(element,fill,suggestion){
      $(element).attr('value',fill);
      $(element).val(fill);
	  document.getElementById('RecommendedID').value = suggestion.service_id;	
	}
</script>
<script type="text/javascript">
	$("#AddRecommendedServices").validate({
			errorElement: "div",
			rules: {
				"searchserviceR" : {
				required : true,
	    	...
	    	submitHandler: function(form) {
				var formData = $("#AddRecommendedServices").serialize(); 
				$.ajax({
		        url: "<?=base_url()?>index.php/BusinessAdmin/AddRecommendedService/",
		        data: formData,
		        type: "POST",
		        crossDomain: true,
						cache: false,
...
<script>
	$(document).on('click','.r_services-edit-btn',function(event) {
      event.preventDefault();
      this.blur(); // Manually remove focus from clicked link.
      var parameters = {
        rservice_id : $(this).attr('rservice_id')
      };
	//   alert($(this).attr('rservice_id'));
      $.getJSON("<?=base_url()?>index.php/BusinessAdmin/EditRecommendedService/", parameters)
      .done(function(data, textStatus, jqXHR) { 
		//   alert(data);
		//   document.getElementById('editsearchserviceR').value=data.result[0].service_name;
        $("#EditRecommendedServices input[name=editsearchserviceR]").attr('value',data.result[0].service_name);
        $("#EditRecommendedServices input[name=editsearchrecommended]").attr('value',data.result[0].recommended_service);
        $("#EditRecommendedServices input[name=editServiceProductid]").attr('value',data.result[0].service_id);
        $("#EditRecommendedServices input[name=editRecommendedID]").attr('value',data.result[0].recommended_service_id);
		$("#EditRecommendedServices input[name=rid]").attr('value',data.result[0].id);
       
        $("#EditModalRecommendation").modal('show');
    	})
    	.fail(function(jqXHR, textStatus, errorThrown) {
        console.log(errorThrown.toString());
   		});
...
<script>
	$("#editsearchserviceR").typeahead({
      autoselect: true,
      highlight: true,
      minLength: 1
     },
     {
      source: editsearchserviceR,
      templates: {
        empty: "No Services Found!",
        suggestion: _.template("<p class='editsearchserviceR'><%- service_name %>,<%- service_type %>,<%- qty_per_item %> </p>")
      }
    });
       
    var to_fill = "";

    $("#editsearchserviceR").on("typeahead:selected", function(eventObject, suggestion, name) {
      var loc = "#editsearchserviceR";
      to_fill = suggestion.service_name;
      setVale(loc,to_fill,suggestion);
    });

    $("#editsearchserviceR").blur(function(){
      $("#editsearchserviceR").val(to_fill);
      to_fill = "";
    });

    function editsearchserviceR(query, cb){
    ...
    function setVale(element,fill,suggestion){
      $(element).attr('value',fill);
      $(element).val(fill);
	  document.getElementById('editServiceProductid').value = suggestion.service_id;	
	}
</script>
<script>
	$("#editsearchrecommended").typeahead({
      autoselect: true,
      highlight: true,
      minLength: 1
     },
     {
      source: editsearchrecommended,
      templates: {
        empty: "No Services Found!",
        suggestion: _.template("<p class='editsearchrecommended'><%- service_name %>,<%- service_type %>,<%- qty_per_item %> </p>")
      }
    });
       
    var to_fill = "";

    $("#editsearchrecommended").on("typeahead:selected", function(eventObject, suggestion, name) {
      var loc = "#editsearchrecommended";
      to_fill = suggestion.service_name;
      setValsER(loc,to_fill,suggestion);
    });

    $("#editsearchrecommended").blur(function(){
      $("#editsearchrecommended").val(to_fill);
      to_fill = "";
    });

    function editsearchrecommended(query, cb){
    ...
    function setValsER(element,fill,suggestion){
      $(element).attr('value',fill);
      $(element).val(fill);
	  document.getElementById('RecommendedID').value = suggestion.service_id;	
	}
...
<script>
	$("#EditRecommendedServices").validate({
			errorElement: "div",
			rules: {
				"editsearchserviceR" : {
				required : true,
           		},
				"editsearchrecommended" :{
				required : true,
	        	},
	        
	    	},
	    	submitHandler: function(form) {
				var formData = $("#EditRecommendedServices").serialize(); 
				$.ajax({
		        url: "<?=base_url()?>index.php/BusinessAdmin/UpdateRecommendedService/",
		        data: formData,
		        type: "POST",
		        crossDomain: true,
						cache: false,
	...
	$(document).on('click','.r_services-deactivate-btn',function(event) {
      event.preventDefault();
      this.blur(); // Manually remove focus from clicked link.
      var parameters = {
        "rservice_id" : $(this).attr('rservice_id'),
      ...
      $.ajax({
        url: "<?=base_url()?>index.php/BusinessAdmin/DeleteRecomService/",
        data: parameters,
        type: "POST",
        crossDomain: true,
				cache: false,
