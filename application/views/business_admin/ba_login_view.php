						...
						<div class="card-body">
							<div class="m-sm-4">
								<div class="text-center">
									<img src="<?=base_url()?>public/images/salonfirst.jpeg" alt="Cashier" width="350" height="100"  />
								</div>
								<form id="BusinessAdminLogin" method="POST" action="#">
									<div class="form-group">
										<label>User Name</label>
										<input class="form-control form-control-lg" type="email" name="business_admin_email" placeholder="Enter your email" required />
									</div>
									<div class="form-group">
										<label>Password</label>
										<input class="form-control form-control-lg" type="password" name="business_admin_password" placeholder="Enter your password" required />	
									</div>
