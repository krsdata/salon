...
<div class="ex1" >
	...
	<div style="font-size:10px">
	  <table  border="0"  width="100%" class="invoice" ><tr><td>
		...
		<?php echo ($shop_details['business_outlet_gst_in']!="") ? "Branch GST No:"."   ".$shop_details['business_outlet_gst_in']: ""; ?></b>
		</td></tr>
		</table>
	</div>
	...
	<div style="width:100px;font-size:10px;">
	  <table  border="0"  width="100%" class="invoice" ><tr>
	     <td>
			<b>Billed To</b><br>
			<b><?php echo $individual_customer['customer_title']." ".$individual_customer['customer_name']." ".$individual_customer['customer_mobile']." ";?></b><br>
			<b>Client GST no: .......................................... </b>
		  </td>
		</tr>
		</table>
...
<tr class="tr-border">
<th style="font-size:9px;width:30%" bgcolor="#e0e0d2">Description</th>
<th style="font-size:8px;width:20%" bgcolor="#e0e0d2">MRP</th>
<th style="font-size:8px;width:10%" bgcolor="#e0e0d2">Qty</th>
<th style="font-size:8px;width:20%" bgcolor="#e0e0d2">Amt</th>
<th style="font-size:8px;width:20%" bgcolor="#e0e0d2">Net Amt</th>
</tr>
...
?>	
						<tr>
						<td style="font-size:8px;" bgcolor="#ccddff">
						<?=$item['service_name']?>
						</td>
						<td style="font-size:8px;" bgcolor="#ccddff"><?=round($mrp)?></td>
						<td style="font-size:8px;" bgcolor="#ccddff">
						<?=$item['service_quantity']?>
						</td>
						<td style="font-size:8px;" bgcolor="#ccddff"><?=round($mrp*$item['service_quantity'])?></td>
						<td style="font-size:8px;" bgcolor="#ccddff"></td>
						</tr>
				   ...
				   <?php if($balance>0){ 
						...
						<tr>
							...
							<td style="font-size:8px;" bgcolor="#ffe6e6"></td>
							<td style="font-size:8px;" bgcolor="#ffe6e6"></td>
							<td style="font-size:8px;" bgcolor="#ffe6e6"><?php echo $memberDiscountAmt; ?></td>
						    <td style="font-size:8px;" bgcolor="#ffe6e6"></td>
						</tr>
						<?php 
				        ...
				        <tr>
							<td  style="font-size:8px" bgcolor="#f2e6ff">
							<b>GST Slab &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $item['service_gst_percentage']; ?>%</b>
							</td>
							<td style="font-size:8px;" bgcolor="#f2e6ff"></td>
							<td  style="font-size:8px" bgcolor="#f2e6ff"></td>
							<td  style="font-size:8px" bgcolor="#f2e6ff"><?php echo round($gst,2); ?></td>
							<td  style="font-size:8px" bgcolor="#f2e6ff"></td>
						</tr>
						
						<tr>
						<td  style="font-size:8px" bgcolor="#cceeff">
						<b>Net Amt</b>
						</td>
						<td style="font-size:8px;" bgcolor="#cceeff"></td>
						<td style="font-size:8px;" bgcolor="#cceeff"></td>
						<td  style="font-size:8px" bgcolor="#cceeff"></td>
						<td  style="font-size:8px" bgcolor="#cceeff"><b><?=round($total_value)?></b></td>
						</tr>
						
						<tr >
							<td  style="font-size:8px" bgcolor="#ffffff"></td>
							<td style="font-size:8px;" bgcolor="#ffffff"></td>
							<td style="font-size:8px;" bgcolor="#ffffff"></td>
							<td  style="font-size:8px" bgcolor="#ffffff"></td>
							<td  style="font-size:8px" bgcolor="#ffffff"></td>
...
<tr>
<td width="50%" style="font-size:10px" bgcolor="#ebfafa">
<b>Gross amt B Tax</b>
</td>
<td width="30%" style="font-size:10px" bgcolor="#ebfafa">
0.00
</td>
<td width="20%" style="font-size:10px" bgcolor="#ebfafa"></td>
</tr>

<tr>
<td width="50%" style="font-size:10px" bgcolor="#f2e6ff">
<b>GST Slab &nbsp;&nbsp;&nbsp;18%</b>
</td>
<td width="30%" style="font-size:10px" bgcolor="#f2e6ff">
0.00
</td>
<td width="20%" style="font-size:10px" bgcolor="#f2e6ff"></td>
</tr>


<tr>
<td width="50%" style="font-size:10px" bgcolor="#cceeff">
<b>Net Amt</b>
</td>
<td width="30%" style="font-size:10px" bgcolor="#cceeff">
</td>
<td width="20%" style="font-size:10px" bgcolor="#cceeff"><b>0.00</b></td>
</tr>
-->
...
-->
<tr>
<td  style="font-size:10px"><center>SGST</center></td>
<td  style="font-size:10px"><center><?=round($totalGst)/2;?></center></td>
</tr>
<tr>
<td style="font-size:10px"><center>CGST</center></td>
<td  style="font-size:10px"><center><?=round($totalGst)/2;?></center></center></td>
</tr>
<tr>
<td  style="font-size:10px"><center>IGST</center></td>
<td  style="font-size:10px"><center>0.00</center></td>
</tr>
<tr>
...
<br><br>
<?php if(isset($gstArray) && count($gstArray)>0){ ?>
<table border=1 width="100%" class="total">
<tr>
<th width="25%" style="font-size:10px"><center>Tax Slab</center></th>
<th width="25%" style="font-size:10px"><center>SGST</center></th>
<th width="25%" style="font-size:10px"><center>CGST</center></th>
<th width="25%" style="font-size:10px"><center>IGST</center></th>
</tr>
<?php foreach($gstArray as $key=>$value){ ?>
<tr>
<th width="25%" style="font-size:10px"><center><?php echo $value['gst']."%"; ?></center></th>
<th width="25%" style="font-size:10px"><center><?=round($value['gst_amt'])/2;?></center></th>
<th width="25%" style="font-size:10px"><center><?=round($value['gst_amt'])/2;?></center></th>
<th width="25%" style="font-size:10px"><center>0</center></th>
</tr>
<?php } ?>
</table>
<?php } ?>
