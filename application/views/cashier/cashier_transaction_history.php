								...
								<div class="tab-pane fade" id="tab-5" role="tabpanel">
									<div class="tab-pane fade show active" id="tab-2" role="tabpanel">
										...
										<div class="col-md-2">
											...
											<div class="col-md-2">
												<button type="submit"
													class="btn btn-primary anniversary">Submit</button>
											</div>
										</form>
											<!-- </div>									 -->
										</div>
        ...
        $(document).on('click', '.anniversary', function(event) {
            ...
            $.getJSON("<?=base_url()?>Cashier/GetCustomerHistoryAnniversary", parameters)
                .done(function(data, textStatus, jqXHR) {
                    // alert(data);
                    if(data.success == 'true'){    
                        var temp_str ="<tr><th>Sr.No</th><th>Name</th><th>Mobile No</th><th>Anniversary</th><th>Lifetime Billing</th><th>Last Visit Date</th></tr>";
                        for (var i = 0; i < data.result.length; i++) {
                            temp_str += "<tr>";
                            temp_str += "<td>" + (i + 1) + "</td>";
                            temp_str += "<td>" + data.result[i].txn_customer_name + "</td>";
