...
<script type="text/javascript">
    ...
    $(".datatables-basic").DataTable({
  	...
  	$("#AddCategory").validate({
	    ...
	    submitHandler: function(form) {
				...
				$.ajax({
		        url: "<?=base_url()?>index.php/MasterAdmin/AddCategory/",
		        data: formData,
		        type: "POST",
		        crossDomain: true,
						cache: false,
	    ...
	    submitHandler: function(form) {
				...
				$.ajax({
		        url: "<?=base_url()?>index.php/MasterAdmin/AddSubCategory/",
		        data: formData,
		        type: "POST",
		        crossDomain: true,
						cache: false,
	    ...
	    submitHandler: function(form) {
				...
				$.ajax({
		        url: "<?=base_url()?>index.php/MasterAdmin/AddService/",
		        data: formData,
		        type: "POST",
		        crossDomain: true,
						cache: false,
      ...
      submitHandler: function(form) {
        ...
        $.ajax({
            url: "<?=base_url()?>index.php/MasterAdmin/AddOTCService/",
            data: formData,
            type: "POST",
            crossDomain: true,
            cache: false,
	    ...
	    submitHandler: function(form) {
				...
				$.ajax({
		        url: "<?=base_url()?>index.php/MasterAdmin/AddRawMaterial/",
		        data: formData,
		        type: "POST",
		        crossDomain: true,
						cache: false,
	    ...
	    submitHandler: function(form) {
				...
				$.ajax({
		        url: "<?=base_url()?>index.php/MasterAdmin/EditCategory/",
		        data: formData,
		        type: "POST",
		        crossDomain: true,
						cache: false,
	    ...
	    submitHandler: function(form) {
				...
				$.ajax({
		        url: "<?=base_url()?>index.php/MasterAdmin/EditSubCategory/",
		        data: formData,
		        type: "POST",
		        crossDomain: true,
						cache: false,
       ...
       /* "service_sub_category_id" :{
	    ...
	    submitHandler: function(form) {
				...
				$.ajax({
		        url: "<?=base_url()?>index.php/MasterAdmin/EditService/",
		        data: formData,
		        type: "POST",
		        crossDomain: true,
						cache: false,
	    ...
	    submitHandler: function(form) {
				...
				$.ajax({
		        url: "<?=base_url()?>index.php/MasterAdmin/EditOTCService/",
		        data: formData,
		        type: "POST",
		        crossDomain: true,
						cache: false,
	    ...
	    submitHandler: function(form) {
				...
				$.ajax({
		        url: "<?=base_url()?>index.php/MasterAdmin/EditRawMaterial/",
		        data: formData,
		        type: "POST",
		        crossDomain: true,
						cache: false,
      ...
      $.getJSON("<?=base_url()?>index.php/MasterAdmin/GetCategory/", parameters)
    ...
    $(document).on('click','.sub-category-edit-btn',function(event) {
      ...
      $.getJSON("<?=base_url()?>index.php/MasterAdmin/GetSubCategory/", parameters)
      .done(function(data, textStatus, jqXHR) { 
    ...
    $(document).on('click','.service-edit-btn',function(event) {
      ...
      $.getJSON("<?=base_url()?>index.php/MasterAdmin/GetService/", parameters)
      .done(function(data, textStatus, jqXHR) { 
    ...
    $(document).on('click','.raw-material-edit-btn',function(event) {
      ...
      $.getJSON("<?=base_url()?>index.php/MasterAdmin/GetRawMaterial/", parameters)
      .done(function(data, textStatus, jqXHR) { 
    ...
    $(document).on('click','.service-deactivate-btn',function(event) {
      ...
      $.ajax({
        url: "<?=base_url()?>index.php/MasterAdmin/DeactivateService/",
        data: parameters,
        type: "POST",
        crossDomain: true,
				cache: false,
    ...
    $(document).on('click','.category-deactivate-btn',function(event) {
      ...
      $.ajax({
        url: "<?=base_url()?>index.php/MasterAdmin/DeactivateCategory/",
        data: parameters,
        type: "POST",
        crossDomain: true,
				cache: false,
    ...
    $(document).on('click','.sub-category-deactivate-btn',function(event) {
      ...
      $.ajax({
        url: "<?=base_url()?>index.php/MasterAdmin/DeactivateSubCategory/",
        data: parameters,
        type: "POST",
        crossDomain: true,
				cache: false,
    ...
    $(document).on('click','.raw-material-deactivate-btn',function(event) {
      ...
      $.ajax({
        url: "<?=base_url()?>index.php/MasterAdmin/DeactivateRawMaterial/",
        data: parameters,
        type: "POST",
        crossDomain: true,
				cache: false,
    ...
    $("#Service-Category-Id").on('change',function(e){
    	...
    	$.getJSON("<?=base_url()?>index.php/MasterAdmin/GetSubCategoriesByCatId/", parameters)
      .done(function(data, textStatus, jqXHR) {
    ...
    $("#OTC-Category-Id").on('change',function(e){
      ...
      var parameters = { "outlet_id" : business_details};
  		...
  		$(this).blur();
  		$.ajax({
        url: "<?=base_url()?>index.php/MasterAdmin/GetCategoriesPublic/",
        data : parameters,
        type: "POST",
        crossDomain: true,
				cache: false,
      ...
      var parameters = {"outlet_id" : business_details};
  		...
  		$(this).blur();
  		$.ajax({
        url: "<?=base_url()?>index.php/MasterAdmin/GetSubCategoriesPublic/",
        type: "POST",
        data : parameters,
        crossDomain: true,
				cache: false,
      ...
      var formData = new FormData(this);
       $.ajax({
        url: "<?=base_url();?>index.php/MasterAdmin/BulkUploadServices",
    ...
    $("#UploadOTC").submit(function(e){
      ...
      var formData = new FormData(this);
       $.ajax({
        url: "<?=base_url();?>index.php/MasterAdmin/BulkUploadOTC/",
        type: "POST",             // Type of request to be send, called as method
        data: formData,
        contentType: "application/octet-stream",
        enctype: 'multipart/form-data',
    ...
    $("#UploadCategory").submit(function(e){
      ...
      var formData = new FormData(this);
       $.ajax({
        url: "<?=base_url();?>index.php/MasterAdmin/BulkUploadCategory/",
        type: "POST",             // Type of request to be send, called as method
        data: formData,
        contentType: "application/octet-stream",
        enctype: 'multipart/form-data',
    ...
    $("#UploadSubCategory").submit(function(e){
      ...
      var formData = new FormData(this);
       $.ajax({
        url: "<?=base_url();?>index.php/MasterAdmin/BulkUploadSubCategory/",
        type: "POST",             // Type of request to be send, called as method
        data: formData,
        contentType: "application/octet-stream",
        enctype: 'multipart/form-data',
    ...
    $("#UploadRawMaterial").submit(function(e){
      ...
      var formData = new FormData(this);
       $.ajax({
        url: "<?=base_url();?>index.php/MasterAdmin/BulkUploadRawMaterial/",
        type: "POST",             // Type of request to be send, called as method
        data: formData,
        contentType: "application/octet-stream",
        enctype: 'multipart/form-data',
          ...
          if(data.success == 'true'){
						$('#defaultModalSuccess').modal('show').on('shown.bs.modal', function (e) {
							$("#SuccessModalMessage").html("").html(data.message);
								...
								window.location.href = "<?=base_url()?>index.php/MasterAdmin/MenuManagement/";
						});
          }
         	else if (data.success == 'false'){                   
      	    $('#defaultModalDanger').modal('show').on('shown.bs.modal', function (e){
...
<script>
	function exportTableToExcel(tableID, filename = ''){
      ...
      if(tableID == 'servicMenu'){
        ...
        $(this).blur();
        $.ajax({
          url: "<?=base_url()?>index.php/MasterAdmin/GetServicePublic/",
          type: "POST",
          data : parameters,
          crossDomain: true,
          cache: false,
        ...
        $(this).blur();
        $.ajax({
          url: "<?=base_url()?>index.php/MasterAdmin/GetProductPublic/",
          type: "POST",
          data : parameters,
          crossDomain: true,
          cache: false,
        ...
        $(this).blur();
        $.ajax({
          url: "<?=base_url()?>index.php/MasterAdmin/GetRawMaterialPublic/",
          type: "POST",
          data : parameters,
          crossDomain: true,
          cache: false,
...
<script>
  function GetCategory()
  {
    ...
    $.getJSON("<?=base_url()?>index.php/MasterAdmin/GetSubCategoriesByCategoryType",parameters)
    .done(function(data,textStatus,jqXHR){
  ...
  function GetService()
  {
    ...
    $.getJSON("<?=base_url()?>index.php/MasterAdmin/GetCategoryByCategoryType",parameters)
    .done(function(data,textStatus,jqXHR){
