	...
	<div class="navbar-collapse collapse">
		<ul class="navbar-nav ml-auto">
			...
			<li class="nav-item dropdown">
				...
				<div class="dropdown-menu dropdown-menu-right">
					<a class="dropdown-item" href="<?=base_url()?>MasterAdmin/Profile"><i class="align-middle mr-1" data-feather="user"></i> Profile</a>
					<a class="dropdown-item" href="<?=base_url()?>MasterAdmin/Logout">Sign out</a>
				</div>
			</li>
		</ul>
	</div>
