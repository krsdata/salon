		      ...
		      <i class="align-middle" data-feather="grid" style="color:#0070c0;"></i> <span class="align-middle">Dashboard</span>
				...
				<ul id="dashboards" class="sidebar-dropdown list-unstyled collapse show">
		          ...
		          <span class="align-middle"><i data-feather="settings" style="color:#d50f25;"></i>Configurations</span>
			        ...
			        <li class="sidebar-item"><a class="sidebar-link" href="<?=base_url()?>MasterAdmin/AddOutlet"><i data-feather="home" style="color:#eeb211;"></i>Outlets</a></li>
						...
						<li class="sidebar-item"><a class="sidebar-link" href="<?=base_url()?>MasterAdmin/MenuManagementNew"><i data-feather="menu" style="color:#d50f25;"></i>Menu Management New</a></li>
						<li class="sidebar-item"><a class="sidebar-link" href="<?=base_url()?>MasterAdmin/MasterAdminAddPackage"><i data-feather="gift" style="color:#0070c0;"></i>Packages</a></li>
