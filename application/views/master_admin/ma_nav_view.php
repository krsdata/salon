<nav class="sidebar <?php if(isset($sidebar_collapsed)){ if($sidebar_collapsed){ echo 'sidebar-collapsed toggled'; }} ?>">
	<div class="sidebar-content">
		<a class="sidebar-brand" href="<?=base_url()?>index.php/MasterAdmin/Dashboard">
	   ...
	   <span class="align-middle">MarkS ReTech</span>
		...
		<ul class="sidebar-nav">
			...
			<li class="sidebar-item">
		      ...
		      <i class="align-middle" data-feather="grid" style="color:#0070c0;"></i> <span class="align-middle">Dashboard</span>
				...
				<ul id="dashboards" class="sidebar-dropdown list-unstyled collapse show">
					<li class="sidebar-item"><a class="sidebar-link" href="<?=base_url()?>index.php/MasterAdmin/Dashboard/"><i data-feather="grid" style="color:#0070c0;"></i>Dashboard</a></li>
					<li class="sidebar-item"><a class="sidebar-link" href="<?=base_url()?>index.php/MasterAdmin/Permissions/"><i data-feather="user-x" style="color:#0070c0;"></i>Users & Permissions</a></li>
					<!--<li class="sidebar-item"><a class="sidebar-link" href="<?=base_url()?>index.php/MasterAdmin/MenuManagement/"><i data-feather="list" style="color:#0070c0;"></i>Menu Management</a></li>-->
					<!--<li class="sidebar-item"><a class="sidebar-link" href="<?=base_url()?>index.php/MasterAdmin/Inventory/"><i data-feather="book" style="color:#0070c0;"></i>Inventory & Stock</a></li>-->
					<!--<li class="sidebar-item"><a class="sidebar-link" href="<?=base_url()?>index.php/MasterAdmin/Employee/"><i data-feather="user" style="color:#0070c0;"></i>Employee Management</a></li>-->
					<!--<li class="sidebar-item"><a class="sidebar-link" href="<?=base_url()?>index.php/MasterAdmin/Discount/"><i data-feather="package" style="color:#0070c0;"></i>Deals & Discounts</a></li>-->
		          ...
		          <span class="align-middle"><i data-feather="settings" style="color:#d50f25;"></i>Configurations</span>
			        ...
			        <!--<li class="sidebar-item"><a class="sidebar-link" href="<?=base_url()?>index.php/BusinessAdmin/AddOutlet/"><i data-feather="home" style="color:#eeb211;"></i>Outlets</a></li>
			    		...
			    		<li class="sidebar-item"><a class="sidebar-link" href="<?=base_url()?>index.php/MasterAdmin/MenuManagement/"><i data-feather="menu" style="color:#d50f25;"></i>Menu Management</a></li>
			...
			<li class="sidebar-item"><a class="sidebar-link" href="<?=base_url()?>index.php/MasterAdmin/ReportsManagement"><i data-feather="book" style="color:#009925;"></i>Reports</a></li>
			<!--  -->
			<!-- <?php
				endif;
			...
			<!-- <li class="sidebar-item">
		      ...
		      <i class="align-middle" data-feather="settings" style="color:#0070c0;"></i> <span class="align-middle">Configurations</span>
				...
				<ul id="autoengage" class="sidebar-dropdown list-unstyled collapse">
					<li class="sidebar-item"><a class="sidebar-link" href="<?=base_url()?>index.php/BusinessAdmin/AutoEngage"><i data-feather="menu" style="color:#d50f25;"></i>Menu Management</a></li>
					<li class="sidebar-item"><a class="sidebar-link" href="<?=base_url()?>index.php/BusinessAdmin/Loyalty"><i class="fa fa-user-friends" style="color:#eeb211;"></i>Employee</a></li>
				</ul>
			</li> -->
			<!-- <?php
				endif;
			...
			<li class="sidebar-item">
		      ...
		      <i class="align-middle" data-feather="user" style="color:green;"></i> <span class="align-middle">User Permissions</span>
				...
				<!-- <ul id="emss" class="sidebar-dropdown list-unstyled collapse">
					...
					<li class="sidebar-item"><a class="sidebar-link" href="<?=base_url()?>index.php/BusinessAdmin/Salary"><i class="fa fa-rupee-sign" style="color:red;"></i>Salary</a></li>
					<li class="sidebar-item"><a class="sidebar-link" href="<?=base_url()?>index.php/BusinessAdmin/Commission"><i class="fa fa-rupee-sign" style="color:#009925;"></i>Commission</a></li>
