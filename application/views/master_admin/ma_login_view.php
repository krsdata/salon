		...
		<div class="row h-100">
			<div class="col-sm-6 col-md-4 col-lg-4 mx-auto d-table h-100">
				<div class="d-table-cell align-middle">
					...
					<!--	<h1 class="h2">Welcome back, Master Admin</h1>-->
					<!--	<p class="lead">-->
							...
							<div class="m-sm-4">
								...
								<form id="MasterAdminLogin" method="POST" action="#" enctype="multipart/form-data">
									<div class="form-group">
										...
										<input class="form-control form-control-lg" type="email" name="master_admin_email" placeholder="Enter your email" required />
									</div>
									<div class="form-group">
										<label>Password</label>
										<input class="form-control form-control-lg" type="password" name="master_admin_password" placeholder="Enter your password" required />	
									</div>
